...
- The **Whore-Maker** has no Headmistress, avatar or simulated human personality. It behaves like machinery running an impersonal service curriculum, calls its enrolled subject “the whore,” and grades posture, oral technique, vocal enthusiasm and obedience. Its articulated penetrative training implement is normally called the **service shaft**.
- The **Beneficent jewelry** silently writes temporary obscene inscriptions such as **HORNY SLUT**, **DENIAL SLUT**, **WHORE FOR USE**, **USE UNTIL SATISFIED** and **VOLUNTEERED WHORE** across exposed skin. Release remains inaccessible until the wearer admits each applied label with convincing personal honesty. Cordelia alone summons, configures and dismisses replica sets; Emily may expose dormant settings or suggest rules but cannot summon the jewelry herself.
- The **Penitent Coil** and Zephira's restraint suite belong to the same Vohl restraint family and do not receive redundant separate personalities. Under Black Rose rules, the family arranges an enrolled wearer for service and releases one restraint section only when another consenting woman reaches orgasm through sufficiently competent attention.
- The **Appraising Glass** remains local, private and non-recording. Its severe setting displays the angles its subject most wants hidden and adds filthy but strictly factual captions about visible arousal, failed resistance and lost composure. It never invents a reaction the image or artifact sensors cannot support.
- The **Resonant Pearl** offers conditional-release wagers. A minority grant release; most failures strengthen stimulation, add time, impose a more exposing position or increase a service requirement. The result is genuinely uncertain rather than secretly predetermined.
- **Courteous Silence** remains a breathable magical ball gag. Its severe timer does not begin or continue until the wearer produces an involuntary vocal response above the selected threshold. Anger, deliberate performance and dignified noises do not qualify.
- The **Mutable Instrument** retains its cheerful automated voice but treats each enrolled body as an incomplete service assignment. It identifies neglected sensitive areas, idle oral functions and available openings, then fills the deficiency with articulated extensions. Its restraints always reroute limbs safely before changing positions.
