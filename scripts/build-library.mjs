...
const entries = [...core, ...aftermath, ...grail, ...zephira, ...cruelty, ...archives].map(finalize);
...
console.log(`Built ${entries.length} chronological entries from ${standalone.length + 6} source files.`);
